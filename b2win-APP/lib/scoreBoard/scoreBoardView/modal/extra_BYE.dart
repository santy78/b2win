...
class ExtrasModalBYE extends StatefulWidget {
  ...
  @override
  _ExtrasModalBYEState createState() => _ExtrasModalBYEState();
}

class _ExtrasModalBYEState extends State<ExtrasModalBYE> {
